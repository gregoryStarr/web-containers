        ...
        <div className="flex-1 overflow-y-auto custom-scrollbar relative bg-[#FDFBF7]">
          <div className="max-w-[1400px] mx-auto p-6 space-y-6">
            ...
            {selectedPR ? (
              ...
              <section className="bg-white/50 border border-dashed border-[var(--color-earth-border)] rounded-earth p-10 flex flex-col items-center justify-center text-center space-y-3">
                <div className="p-4 bg-stone-100/50 rounded-full">
